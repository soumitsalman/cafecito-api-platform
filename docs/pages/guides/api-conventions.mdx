...
| Bean `full_content=true` | It does not guarantee a full source copy, the most current copy, or republication rights. Handle a missing or partial `content` value, cite the canonical Article `url`, and follow the [Third-Party Content Policy](https://cafecito.tech/docs/third-party-content-policy/). |
