...
Unknown query parameters are silently ignored. Malformed UUIDs, malformed cursors, and out-of-range `limit` values are **rejected** with HTTP `400` and the error envelope below.
