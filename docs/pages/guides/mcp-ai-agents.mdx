---
description: Connect AI agents to Cafecito's hosted Beans and Espresso MCP servers with Bearer authentication, REST equivalents, and tool workflows.
---
...
- **Espresso MCP**: Espresso is a market, business, event, and news intelligence API for searching concrete Events, interpreting Signals, and tracing evidence and Sources. GDELT and Perigon are comparison patterns, not claims of route-for-route equivalence.
