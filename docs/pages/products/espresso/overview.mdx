...
pagination:
  ...
  next_page: null
meta:
  as_of: 2026-08-14T17:44:34.897815116Z
```

```text title="TOON"
data[1]:
  - activities[2]: 2026-08-13 NDC president Peter Obi declares Nigerian youths great assets,2026-08-13 Former Anambra Governor Peter Obi emphasizes need for investment in youth sectors
    created_at: "2026-08-13T06:30:04Z"
    event_type: youth_empowerment_declaration
    forecast: Increased public funding directed at youth programs within six months
    id: 9cefc4ae-cad9-548e-9f5f-28ef22327a13
    impact_level: high
...
pagination:
  ...
  next_page: null
meta:
  as_of: "2026-08-14T17:44:34.912410727Z"
```
</CodeTabs>

Use JSON when a client needs strict JSON parsing. Use YAML when readable indentation is more useful. Use TOON when an agent needs the same fields in the most compact representation. `pagination.next_page` remains opaque in every format: send it unchanged as the next request `page`.
