---
description: Market & business intelligence API for searching events, signals, and tracing evidence.
---
...
Espresso is a market and business intelligence API for searching concrete events, signals, and tracing evidence for monitoring, research, risk analysis, and AI-agent workflows. Use it for searching: what happened, what it may mean for a company or market, and what evidence supports that view.
