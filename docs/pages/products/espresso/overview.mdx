...
**In one line:** The Espresso API is a read-only API providing searchable business intelligence through concrete Events, synthesized Signals, evidence, and Sources for research, monitoring, and AI-agent applications.
