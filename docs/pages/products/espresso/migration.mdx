---
description: Migrate your market intelligence API to use Espresso API. Map GDELT, PredictHQ and Perigon event-intelligence patterns to Espresso Events, Signals, evidence, and Sources without claiming route-for-route equivalence. GDELT, PredictHQ and Perigon are comparison patterns, not a claim that Espresso copies every provider route or field.
---

# Migrate to Espresso

Espresso is a market & business intelligence API. If you want to know
