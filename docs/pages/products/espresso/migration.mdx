---
description: Migrate to Espresso’s market, business, event, and news intelligence API. GDELT and Perigon are comparison patterns, not claims of route-for-route equivalence.
---

# Migrate to Espresso

Espresso is a market, business, event, and news intelligence API. GDELT and Perigon are comparison patterns, not claims of route-for-route equivalence. If you want to know
