---
title: Workflows for Business Intelligence
...
Espresso aims to answer what is happening with the market and their downstream impact: Events for what happened, Signals for impact or outlook, evidence for why you should trust the conclusion. Espresso answers richer questions through a small sequence of focused calls. Start with the route that matches the user question, carry forward only returned IDs or filter values, and stop once the answer has enough support.
