---
title: Beans API Workflows for Feeds, Sources, and Stories
...
2. `GET /beans/articles/top-headlines` for the fixed recent attention window (news only; no `content_type` or dates).
