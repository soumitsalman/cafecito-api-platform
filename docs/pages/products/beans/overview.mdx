---
title: Beans News and Publisher Content API
description: Read-only publisher-content API for news, blogs, earnings and financial reports, litigation, official statements, research, technical documents, Sources, and Stories.
---
...
**In one line:** Beans is a read-only publisher-content API for news, blogs, financial and earnings reports, litigation and lawsuits, official statements, research, technical documents, and related coverage context.
...
Beans reports publisher material and coverage context. It does not produce Espresso Events, Signals, impact, or forecast.

There is no official Cafecito SDK. Integrate with REST or MCP. Cortado and Latte are reserved products and are not live APIs.
