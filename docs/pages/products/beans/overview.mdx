---
title: Overview
description: Search curated news and blogs, monitor trends, and track story propagation with Beans.
---
...
See the [MCP Integration guide](/guides/mcp-ai-agents) for client setup patterns.
