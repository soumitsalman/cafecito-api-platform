...
**In one line:** The Beans API is a read-only API providing searchable and filterable access to publisher Articles, Sources, Stories, feeds, and coverage context for news, research, and AI-agent applications.
