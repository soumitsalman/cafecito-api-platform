...
- **Content Diversity**: In addition to news, Beans provides public-information discovery across blogs, corporate announcements, earnings reports, litigation, official statements, research, technical documents, and coverage context. It is designed for workflows that need source material, metadata, and tracking of related coverage across sources/outlets and social platforms.
