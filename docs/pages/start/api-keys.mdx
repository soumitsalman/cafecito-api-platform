...
Creating or using an API key means you agree to the [Terms of Service](https://cafecito.tech/docs/terms-of-use/), [Acceptable Use Policy](https://cafecito.tech/docs/acceptable-use-policy/), and [Privacy Policy](https://cafecito.tech/docs/privacy-policy/). Third-party source material remains subject to the [Third-Party Content Policy](https://cafecito.tech/docs/third-party-content-policy/).
