---
title: Create a Cafecito API key
description: Create a Bearer API key that authenticates Beans and Espresso REST and MCP. Health routes stay public.
---
...
<Stepper>
1. Open [API Keys](/settings/api-keys) in the developer portal.
2. Create a key and store it in a secret manager or `CAFECITO_API_KEY`. Never commit it.
3. On every authenticated request, send:
