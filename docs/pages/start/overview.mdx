---
description: Explore Cafecito's live Beans public-information discovery API and Espresso market, business, event, and news intelligence API with one API key and MCP servers.
---
...
| --- | --- | --- |
| [**Beans**](/products/beans) — Public-information discovery | <Badge className="badge-live">Live</Badge> | Beans is a public-information discovery API for news, blogs, financial and earnings reports, litigation and lawsuits, official statements, research, technical documents, and related coverage context. |
...
- To combine Beans source material with Espresso Events and Signals, see [Cross-product workflow](/guides/cross-product-workflow).
