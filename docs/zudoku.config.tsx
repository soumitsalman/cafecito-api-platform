...
const config: ZudokuConfig = {
      ...
      items: [
        ...
        { type: "doc", file: "contact" },
        {
          ...
          items: [
            ...
            { type: "link", to: "https://cafecito.tech/docs/overview/", label: "Company Overview" },
            { type: "link", to: "https://cafecito.tech/docs/legal/", label: "Canonical Policy Index" },
            { type: "link", to: "https://cafecito.tech/docs/terms-of-use/", label: "Terms of Service" },
            { type: "link", to: "https://cafecito.tech/docs/acceptable-use-policy/", label: "Acceptable Use Policy" },
            { type: "link", to: "https://cafecito.tech/docs/privacy-policy/", label: "Privacy Policy" },
            { type: "link", to: "https://cafecito.tech/docs/third-party-content-policy/", label: "Third-Party Content Policy" },
            { type: "link", to: "https://cafecito.tech/docs/publisher-requests/", label: "Publisher Requests" },
            { type: "link", to: "https://cafecito.tech/docs/copyright-policy/", label: "Copyright Policy" },
            { type: "link", to: "https://cafecito.tech/docs/corrections-policy/", label: "Corrections Policy" },
            { type: "link", to: "https://cafecito.tech/docs/public-information-collection-policy/", label: "Public-Information Collection" },
            { type: "link", to: "https://cafecito.tech/docs/editorial-and-ai-policy/", label: "Editorial and AI Policy" },
          ],
        },
      ],
    },
  ...
  redirects: [
    ...
    { from: "/company/about-us", to: "https://cafecito.tech/docs/overview/" },
    { from: "/company/terms-of-use", to: "https://cafecito.tech/docs/terms-of-use/" },
    { from: "/company/acceptable-use-policy", to: "https://cafecito.tech/docs/acceptable-use-policy/" },
    { from: "/company/privacy-policy", to: "https://cafecito.tech/docs/privacy-policy/" },
    { from: "/company/content-rights-policy", to: "https://cafecito.tech/docs/third-party-content-policy/" },
    { from: "/company/publisher-requests", to: "https://cafecito.tech/docs/publisher-requests/" },
    { from: "/company/copyright-policy", to: "https://cafecito.tech/docs/copyright-policy/" },
    { from: "/company/corrections-policy", to: "https://cafecito.tech/docs/corrections-policy/" },
    { from: "/company/automated-collection-policy", to: "https://cafecito.tech/docs/public-information-collection-policy/" },
  ],
  apis: [
    {
      type: "file",
