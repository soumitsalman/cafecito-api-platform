      ...
      items: [
        ...
        { type: "doc", file: "contact" },
        {
          ...
          items: [
            ...
            { type: "doc", file: "company/acceptable-use-policy" },
            { type: "doc", file: "company/privacy-policy" },
            { type: "doc", file: "company/content-rights-policy" },
            { type: "doc", file: "company/publisher-requests" },
            { type: "doc", file: "company/copyright-policy" },
            { type: "doc", file: "company/corrections-policy" },
            { type: "doc", file: "company/automated-collection-policy" },
          ],
        },
      ],
    },
