    ...
    "paths": {
        ...
        "/sources/{source_id}": {
            "get": {
                ...
                "description": "Returns provenance metadata for one Source. Use this route to enrich a citation or inspect publisher metadata, not to retrieve published Events.\nTo find Events from this Source, call ` + "`" + `GET /events?source_ids={source_id}` + "`" + `. Optional source-description, favicon, and source-reference fields can be absent when unavailable.",
                "produces": [
                    "application/json"
                ],
                "tags": [
